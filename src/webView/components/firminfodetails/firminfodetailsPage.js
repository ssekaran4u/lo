...
import Firminfodetails from "./firminfodetails";
/**
* @author
* @function RegisterPage
**/

const FirminfodetailsPage = (props) => {
  ...
  return(
    ...
    <div className="lo-container">
        ...
        <div className="lo-right-container">
          <div class="lo-links">
            <span class="lo-text">Already have an account?</span>
            <a href="login.html">
              <button class="LoBtnBase-root LoBtn-root LoBtn-outlined default-btn" type="button">
                <span class="LoBtn-label">SIGN IN</span>
                <span class="LoTouchRipple-root"></span>
              </button>
              </a>
          </div>
...
export default FirminfodetailsPage;